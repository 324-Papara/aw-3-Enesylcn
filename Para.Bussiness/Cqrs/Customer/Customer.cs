...
public record GetCustomerByIdWhereQuery(long CustomerId) : IRequest<ApiResponse<List<CustomerResponse>>>;

public record GetCustomerByIdIcludeQuery() : IRequest<ApiResponse<List<CustomerResponse>>>;